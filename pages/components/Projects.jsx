    ...
    <ProjectContainer>
      <InnerProjectContainer>
        <ProjectContainerTitle>Projects</ProjectContainerTitle>
          ...
          <ProjectCard>
            <VideoContainer>
              <ProjectVideo autoPlay muted controls playsInline loop src='/synamatic screencapture (1).mov'/>
            </VideoContainer>
            <ProjectAboutcontainer>
          ...
          <ProjectCard>
            <VideoContainer>
              <ProjectVideo autoPlay muted controls playsInline loop src='/DemingSD.mp4'/>
            </VideoContainer>
            <ProjectAboutcontainer>
          ...
          <ProjectCard>
            <VideoContainer>
              <ProjectVideo autoPlay muted controls playsInline loop src='/deming-twitter.mov'/>
            </VideoContainer>
            <ProjectAboutcontainer>
